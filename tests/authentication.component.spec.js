...
const TEST_PASSWORD_1 = process.env.TEST_PASSWORD_1 || 'testpass1'; // NOSONAR
const TEST_PASSWORD_2 = process.env.TEST_PASSWORD_2 || 'testpass2'; // NOSONAR
const TEST_PASSWORD_MATCH = process.env.TEST_PASSWORD_MATCH || 'testpassmatch'; // NOSONAR
