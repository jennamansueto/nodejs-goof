...
const TEST_CREDENTIALS = {
  mismatchFirst: 'testValue1',
  mismatchSecond: 'testValue2',
  matching: 'testMatchingValue',
};
...
describe('Component Tests', () => {
  describe('PasswordComponent', () => {
    ...
    test('should show error if passwords do not match', () => {
      // GIVEN
      comp.password = TEST_CREDENTIALS.mismatchFirst;
      comp.confirmPassword = TEST_CREDENTIALS.mismatchSecond;
      // WHEN
      comp.changePassword();
      // THEN
